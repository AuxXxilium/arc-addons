...
EOF
  ...
  [ -f "/tmpRoot/usr/bin/arc-fancontrol.sh" ] && rm -f /tmpRoot/usr/bin/arc-fancontrol.sh
  [ -f "/tmpRoot/usr/lib/systemd/system/multi-user.target.wants/fancontrol.service" ] && rm -f "/tmpRoot/usr/lib/systemd/system/multi-user.target.wants/fancontrol.service"
  [ -f "/tmpRoot/usr/lib/systemd/system/fancontrol.service" ] && rm -f "/tmpRoot/usr/lib/systemd/system/fancontrol.service"
