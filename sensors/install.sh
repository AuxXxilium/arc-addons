...
EOF
  ...
  [ -e "/tmpRoot/usr/lib/systemd/system/multi-user.target.wants/fancontrol.service" ] && rm -f "/tmpRoot/usr/lib/systemd/system/multi-user.target.wants/fancontrol.service"
  [ -e "/tmpRoot/usr/lib/systemd/system/fancontrol.service" ] && rm -f "/tmpRoot/usr/lib/systemd/system/fancontrol.service"
